...
const Square = ({ slice}) => {
  ...
  return(
    <div className='item-wrapper'>
      <div className='item' onClick={toggleItem} style={{backgroundImage: `url(${slice.primary.agenda_item.data.image.url})`}} >
      ...
      <div className='content'>
        <PrismicRichText field={slice.primary.agenda_item.data.slices?.[0]?.primary.text}/>
      </div>
    </div>
  )
}
